...
*/
  ...
  //Aliases
  log: function( level, message, data ) { this.logger.log( level, message, data||null ); },
  info: function( message, data ) { this.logger.log( "info", message, data||null ); },
  warn: function( message, data ) { this.logger.log( "warn", message, data||null ); },
  error: function( message, data ) { this.logger.log( "error", message, data||null ); },
  debug: function( message, data ) { this.logger.log( "debug", message, data||null ); },
