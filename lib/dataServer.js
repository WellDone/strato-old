...
dataServer.prototype = {
  ...
  parseReport: function( from, reportValue ) {
    var momoReportVersion = reportValue[0];
    if ( momoReportVersion == 1 ) //TODO: Make extensible
    {
      var report = {};
      report.batteryVoltage = reportValue.readUInt16LE(1);
      ...
      console.log( "Unrecognized MoMo report format version " + momoReportVersion + ".");
      return;
    }
  }
}
